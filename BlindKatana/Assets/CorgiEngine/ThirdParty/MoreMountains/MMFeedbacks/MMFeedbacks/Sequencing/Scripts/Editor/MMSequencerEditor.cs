...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMSequencerEditor : Editor
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            _indexStyle.normal.background = null;
        ...
        protected virtual void DrawSequenceIndexes()
        {
            ...
            GUILayout.Label("", GUILayout.Width(_trackControlWidth + _distanceBetweenButtons*1.5f), GUILayout.Height(_trackControlWidth));
            string label = "";
            for (int i = 0; i < _targetSequencer.SequencerLength; i++)
            {
                label = i < 10 ? " " + i.ToString() : i.ToString();
                _indexStyle.fontStyle = (i % 4 == 0) ? FontStyle.Bold : FontStyle.Normal;
        ...
        protected virtual void DrawTrack(int trackIndex)
        {
            ...
            _trackControlColor = _targetSequencer.Sequence.SequenceTracks[trackIndex].TrackColor;
            _controlColor = Application.isPlaying ? SequencerColor(_trackControlLastUseTimestamps[trackIndex], _trackControlColor) : Color.white;
