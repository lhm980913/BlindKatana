...
{
    public class OneWayLevelManager : Singleton<OneWayLevelManager>, MMEventListener<CorgiEngineEvent>
    {
        ...
        [Information("Add this component to a LevelManager, and it'll let you define one way level behaviours. " +
            ...
            "or even force auto scrolling in a direction.", InformationAttribute.InformationType.Info, false)]
        ...
        [Condition("PreventGoingBack", true)]
        ...
        [Condition("OneWayLevelAutoScrolling", true)]
        ...
        {
            _cameraController = MainCamera.gameObject.MMGetComponentNoAlloc<CameraController>();
        ...
        protected virtual void HandleAutoMovement()
        {
            ...
            switch (OneWayLevelDirection)
            {
                ...
                case OneWayLevelDirections.Up:
                    ...
                    MaxBounds.y = MinBounds.y + MainCamera.MMCameraWorldSpaceWidth();
                    break;
                case OneWayLevelDirections.Down:
                    MinBounds.y = MaxBounds.y - MainCamera.MMCameraWorldSpaceWidth();
